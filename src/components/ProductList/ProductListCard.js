...
import dummyHP from '../../assets/images/dummy-hp.png';
...
const ProductListCard = () => {
    ...
    return (
        <div className='rounded-[36px] border border-ss-grey-secondary p-8'>
            <div>
                <img className='w-full' src={dummyHP} alt='Dummy' />
                <h3 className='mt-6 text-lg font-semibold'>Wireless Headphones</h3>
            </div>
            <div className='mt-5 flex justify-between items-end'>
                <div className='flex'>
                    <p className='font-light text-lg'>$56.00</p>
                    <p className='ml-5 font-light text-lg text-ss-light-orange-secondary line-through'>$60.00</p>
                </div>
                <div>
